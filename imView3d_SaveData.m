...
im2.gui.editNslices = get(handles.editNslices,'string');

im2.gui.checkboxCenterStep = get(handles.checkboxCenterStep,'value');
im2.gui.checkboxOverlayWoGraph = get(handles.checkboxOverlayWoGraph,'value');
...
im2.gui.menu_fastFillCircle = get(handles.menu_fastFillCircle,'checked');
im2.gui.menu_useSegDiam = get(handles.menu_useSegDiam,'checked');

im2.overlay = get(handles.popupmenuOverlay,'value');
